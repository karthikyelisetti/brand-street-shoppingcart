// Function to fetch the Home-furnish category card details
function fetchHomeFurnishDetails() {
    var card = "";
    ...
    fetch("https://dummyjson.com/products/category/furniture")
      ...
      .then((data) => {
        ...
        document.getElementById("fur-card").innerHTML = card;
      });
  ...
  function fetchCategoryDetails(id) {
    ...
    fetch(`https://dummyjson.com/products/category/${id}`)
      ...
      data.products.forEach((object) => {
        ...
        document.getElementById("fur-card").innerHTML = indvCard;
      });
  }
  
  // Calling function to populate the cards
//   fetchSideBarDetails();
fetchHomeFurnishDetails();
